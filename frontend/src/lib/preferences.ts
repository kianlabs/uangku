 ...
 *
 * Backend adalah source of truth. LocalStorage dipakai sebagai cache lokal
 ...
 *   2. Seed localStorage dengan nilai backend
 *   3. Komponen baca dari localStorage seperti biasa
 *
 * Write flow:
 *   1. Tulis ke localStorage (sync, instant)
 *   2. PATCH ke backend secara fire-and-forget (tidak block UI)
 */
