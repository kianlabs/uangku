...
const variantStyles: Record<Variant, string> = {
  primary:
    "bg-accent text-accent-ink hover:bg-[#164030] active:scale-[0.97] disabled:opacity-50",
  secondary:
  ...
  danger:
    "bg-danger text-white hover:bg-[#7f1d1d] active:scale-[0.97] disabled:opacity-50",
};
